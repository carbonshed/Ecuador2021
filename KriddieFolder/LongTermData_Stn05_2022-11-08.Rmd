...
##check data
plot_ly(LUXabajo_05_Lux_data, x = ~DateTime, y = ~Lux, type = 'scatter', mode = 'markers') 


plot_ly(LUXarriba_05_Lux_data, x = ~DateTime, y = ~Lux, type = 'scatter', mode = 'markers') 
