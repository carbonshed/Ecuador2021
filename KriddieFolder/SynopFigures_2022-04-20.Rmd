...
CO2 <- ggplot(df, aes(x = Wetland_2, y = log10(adjusted_ppm), fill = Wetland_2)) +
  ...
  scale_y_continuous(breaks=c(log10(300),log10(1000), log10(3000), log10(10000)), labels=c("300","1,000","3,000","10,000"))  +
  annotate("text", x="Gavilan Tributaries", y= log10(18000),label="B", size = 8) +
  annotate("text", x="Antenas", y= log10(18000),label="A", size = 8) +
  annotate("text", x="Gavilan Mainstem", y= log10(18000),label="A", size = 8) +
  annotate("text", x="Colmillo", y= log10(18000),label="A", size = 8)
...
flux <- ggplot(df, aes(x = Wetland_2, y = Flux_ave, fill = Wetland_2)) + 
  ...
  scale_fill_discrete(name=NULL) +
  annotate("text", x="Gavilan Tributaries", y= 5,label="BC", size = 8) +
  annotate("text", x="Antenas", y= 5,label="A", size = 8) +
  annotate("text", x="Gavilan Mainstem", y= 5,label="AC", size = 8) +
  annotate("text", x="Colmillo", y= 5,label="B", size = 8)
