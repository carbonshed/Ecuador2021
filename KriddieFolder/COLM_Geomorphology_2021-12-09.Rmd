...
synop <- synop[,c("Date","EOS_no","Flux_ave","Point","CO2_ppm_ave","adjusted_ppm","lon_fit","lat_fit")]
...
write.csv(df_prediction, here::here("ProcessedData/COLMILLO_synoptic_2022-01-27.csv"))
```
