...
TrackMap_geo <- qmplot(lon, lat, data = Geomorph_3, zoom = 13, maptype = "toner-background")
TrackMap_geo
...
TrackMap_2 <- qmplot(lon, lat, data = Synop_2, zoom = 13,
                   maptype = "toner-background", color=EOS_no,shape = as.factor(Date))
TrackMap_2
...
df <- full_join(Synop_2,Geomorph_3, by=c("lat","lon")) 
