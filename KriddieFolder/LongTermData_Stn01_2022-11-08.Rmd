...
##check data
plot_ly(LUXabajo_01_Lux_data, x = ~DateTime, y = ~Lux, type = 'scatter', mode = 'markers') 


plot_ly(LUXarriba_01_Lux_data, x = ~DateTime, y = ~Lux, type = 'scatter', mode = 'markers') 
