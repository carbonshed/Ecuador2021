...
df_prediction <- read.csv(here::here("ProcessedData/ANTE_synoptic_2022-06-04.csv"))
...
write.csv(df_prediction_4, here::here("ProcessedData/ANTE_synopticGeom_2022-06-04.csv"))
