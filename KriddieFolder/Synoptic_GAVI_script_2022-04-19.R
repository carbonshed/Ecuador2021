...
new$adjusted_ppm <- 
  ...
  (1 - (25 - new$GAVI_waterTempAve) * 0.005)
...
CO2_map <- qmplot(Lat, Lon, data = CO2_synop_pivot, zoom = 13,  maptype = "toner-background", color = log10(adjusted_ppm))+
  scale_color_gradient(low="blue", high="red")
...
write.csv(synop_merge, here::here("Synoptic/GAVI_2022-04-19.csv"))
