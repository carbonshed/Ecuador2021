...
model1.2 <- lm(log(pCO2_ppm) ~ log1p(slope_m.m) #+
...
anova.flux <- aov(F_CO2_umol_m2_s ~ Wetland_5, data = df)
summary(anova.flux)

anova.k600 <- aov(K600 ~ Wetland_5, data = df%>%filter(K600>-30) )
summary(anova.k600)
...
model1_1 <- lm(log(F_CO2_umol_m2_s) ~ log(adjusted_ppm), 
