...
#?get_stadiamap()
gaviplot <- qmplot(lon_fit,lat_fit, data = df%>%filter(Wetland_3=="Gavilan River Network")%>%drop_na(adjusted_ppm), zoom = 13, size= 10, maptype = "stamen_terrain", color = log10(adjusted_ppm))+
  guides(size = "none") +
