...
LUXabajo_05_Lux_data$Station <- "Stn04"
LUXarriba_05_Lux_data <- "Stn04"
...
##check data
plot_ly(LUXabajo_04_Lux_data, x = ~DateTime, y = ~Lux, type = 'scatter', mode = 'markers') 


plot_ly(LUXarriba_04_Lux_data, x = ~DateTime, y = ~Lux, type = 'scatter', mode = 'markers') 
