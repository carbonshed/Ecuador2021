...
all_data_bind$k600_eq1_2 <- ((all_data_bind$v_ms * all_data_bind$slope_mid)^.89 * (all_data_bind$depth/100)^0.54 * 5037)*.92+.98

all_data_bind$k600_eq1_2ulseth <-   exp(5.137 + .468*log(all_data_bind$v_ms * all_data_bind$slope_mid) + .242*log(all_data_bind$depth))
...
#write.csv(all_data_bind,here::here("ProcessedData/AllSynoptic_raymondk600_Oct5.csv"))
...
#write.csv(allsites_df,here::here("ProcessedData/CumulativeFlux_raymondk600_Oct5.csv"))
