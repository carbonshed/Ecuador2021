...
###
df_prediction <- df_prediction_1[order(df_prediction_1$dist),]
...
ggplot(data=df_prediction_1%>%drop_na(Flux_ave), aes(dist, ele_fit, color=Date)) +
  geom_point()

ggplot(data=df_prediction_1, aes(dist, ele_fit, col="CO2_ppm_ave")) +
...
write.csv(df_prediction_1, here::here("ProcessedData/GAVI_Trib1_synoptic_2022-02-18.csv"))
```
