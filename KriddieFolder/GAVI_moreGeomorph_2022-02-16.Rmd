...
```{r read in data}
df_prediction <- read.csv(here::here("ProcessedData/GAVI_synoptic_2022-03-24.csv"))
...
write.csv(df_prediction_4, here::here("ProcessedData/GAVI_synopticGeom_2022-03-24.csv"))
