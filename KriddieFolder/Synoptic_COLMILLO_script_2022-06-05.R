...
CO2_map <- qmplot(lon,lat, data = CO2_synop_pivot, zoom = 13,  maptype = "toner-background", color = adjusted_ppm, shape=EOS_no) +
scale_color_gradient(low="blue", high="red")
...
Flux_map <- qmplot(lon, lat, data = Flux_synop_pivot, zoom = 13,  maptype = "toner-background", color = Flux_ave, shape=EOS_no)#+
#  scale_color_gradient(low="blue", high="red")
