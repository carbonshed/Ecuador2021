...
LUXabajo_05_Lux_data$Station <- "Stn02"
LUXarriba_05_Lux_data <- "Stn02"
...
##check data
plot_ly(LUXabajo_02_Lux_data, x = ~DateTime, y = ~Lux, type = 'scatter', mode = 'markers') 


plot_ly(LUXarriba_02_Lux_data, x = ~DateTime, y = ~Lux, type = 'scatter', mode = 'markers') 
