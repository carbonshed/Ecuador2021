...
df_prediction <- read.csv(here::here("ProcessedData/GAVI_Trib2_synoptic_2022-06-08.csv"))
...
XWD <- read.csv(here::here("Geomorphology/Gavilan/GAVItrib2_2022-08-30.csv"))

XWD <- XWD[,c("lon","lat","x","d","w","ele","notes")]

#switch around order so upstream to upstream
...
df_prediction_3 <- df
#write.csv(df_prediction_3, here::here("ProcessedData/Gavitrib2_XWD.csv"))
...
write.csv(df_prediction_4, here::here("ProcessedData/GAVItrib2_synopticGeom_2022-08-30.csv"))
