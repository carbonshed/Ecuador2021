---
title: "Geomorphology_GAVI trib3"
author: "KWhitmore"
date: "12/09/2021"
...
synop <- synop%>%select(lat,lon,Date,EOS_no,Flux_ave,Tract,Point,VaisalaType,CO2_ppm_ave,WaterTemp_c,BaroPress_kpa,AirTemp_c,Total_hPa,adjusted_ppm,DOC,TDN)
...
##check should have 7 synop points 
check <- df_prediction%>%drop_na(Date)

#write.csv(df_prediction, here::here("ProcessedData/gaviTrib3_synoptic_2024-09-04.csv"))
#write.csv(check, here::here("ProcessedData/gaviTrib3_synopticpoints_arcpro_2024-09-04.csv"))
...
df_prediction <- read.csv(here::here("ProcessedData/gaviTrib3_synoptic_2024-09-04.csv"))
df_prediction$X <- NULL

XWD <- read.csv(here::here("Geomorphology/Gavilan/GAVItrib3_2024-09-10.csv"))
...
write.csv(df_prediction_5, here::here("ProcessedData/ArcPro_inport/GaviTrib3_XWD.csv"))
