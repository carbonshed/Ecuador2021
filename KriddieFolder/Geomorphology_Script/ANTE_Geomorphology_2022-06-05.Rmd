...
#synop <- read.csv(here::here("Synoptic/ANTE_2022-04-19.csv"))
...
ggplot(data=df_prediction %>%drop_na(Flux_ave), aes(dist, ele_fit, color=Flux_ave)) +
  geom_point(size=5)
ggplot(data=df_prediction %>%drop_na(Flux_ave), aes(dist, ele_fit, color=DOC)) +
  geom_point(size=5)
...
write.csv(df_prediction, here::here("ProcessedData/ANTE_synoptic_2022-06-07.csv"))
...
#write.csv(WaterChem2, here::here("ProcessedData/ANTE_WaterChem_synop_2022-04-19.csv"))
