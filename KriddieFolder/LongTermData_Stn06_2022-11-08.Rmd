...
##check data
plot_ly(LUXabajo_06_Lux_data, x = ~DateTime, y = ~Lux, type = 'scatter', mode = 'markers') 


plot_ly(LUXarriba_06_Lux_data, x = ~DateTime, y = ~Lux, type = 'scatter', mode = 'markers') 
