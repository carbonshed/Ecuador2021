...
```{r synop, echo=FALSE}
synop <- left_join(df_prediction,df_prediction_3, by=c("lon_fit","lat_fit","dist"))
synop <- synop[,-c(6:12)]
synop <- synop[order(synop$dist),]
test <- synop[,c("lon_fit","lat_fit","dist","Date","Flux_ave","x_pred","w","d")]
##find midpoint distance between synop measurments.
