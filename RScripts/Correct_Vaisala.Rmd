...
#this is nt true! the new vaisalas were NOT set to 700 and 6.7, they were left as the default ALSO the units were set wierd so they are half of what they should be
...
df_new$adjusted_ppm <- (df_new$ppm * 2 )* (1 + (1013 - df_new$Total_hPa) * 0.0015) * (1 - (25 - df_new$WLTemp_c) * 0.003)
