...
#WL_01$WLPres_kpa <- WL_01$WLPres_kpa *0.10197442889221
#WL_02$WLPres_kpa <- WL_02$WLPres_kpa *0.10197442889221
#WL_03$WLPres_kpa <- WL_03$WLPres_kpa *0.10197442889221
#WL_04$WLPres_kpa <- WL_04$WLPres_kpa *0.10197442889221
#WL_05$WLPres_kpa <- WL_05$WLPres_kpa *0.10197442889221
#WL_06$WLPres_kpa <- WL_06$WLPres_kpa *0.10197442889221

Baro <- Baro%>%filter(DateTime > as.POSIXct("2021-06-11 00:00:00"))

WL_01 <- WL_01[,c("DateTime","WL_m","WLTemp_c")]
WL_02 <- WL_02[,c("DateTime","WL_m","WLTemp_c")]
WL_03 <- WL_03[,c("DateTime","WL_m","WLTemp_c")]
WL_04 <- WL_04[,c("DateTime","WL_m","WLTemp_c")]
WL_05 <- WL_05[,c("DateTime","WL_m","WLTemp_c")]
WL_06 <- WL_06[,c("DateTime","WL_m","WLTemp_c")]

colnames(WL_01) <- c("DateTime","Stn01_WL_m","Stn01_WLTemp_C")
colnames(WL_02) <- c("DateTime","Stn02_WL_m","Stn02_WLTemp_C")
colnames(WL_03) <-  c("DateTime","Stn03_WL_m","Stn03_WLTemp_C")
colnames(WL_04) <- c("DateTime","Stn04_WL_m","Stn04_WLTemp_C")
colnames(WL_05) <- c("DateTime","Stn05_WL_m","Stn05_WLTemp_C")
colnames(WL_06) <- c("DateTime","Stn06_WL_m","Stn06_WLTemp_C")
...
write.csv(All_WL_wide, here::here("WaterLevel/WaterLevel_merge_2021-06-11_2021-10-01.csv"),
          row.names = FALSE)
