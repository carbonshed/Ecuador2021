...
WL_02 <- WL_02[,c("DateTime","BaroTemp_c","WLTemp_c","Station","WL_m")]
WL_02$Q_m3s <- 1.2949*(WL_02$WL_m)^2 - 0.1622*WL_02$WL_m + 0.0041

WL_01 <- Baro_corrected %>% filter(Station == "WL_01")
WL_01 <- WL_01[,c("DateTime","BaroTemp_c","WLTemp_c","Station","WL_m")]
...
WL_03 <- WL_03[,c("DateTime","BaroTemp_c","WLTemp_c","Station","WL_m")]
...
WL_04 <- WL_04[,c("DateTime","BaroTemp_c","WLTemp_c","Station","WL_m")]
...
WL_06 <- WL_06[,c("DateTime","BaroTemp_c","WLTemp_c","Station","WL_m")]
WL_06$Q_m3s <- 1.2949*(WL_06$WL_m)^2 - 0.1622*WL_06$WL_m + 0.0041

WL_05 <- Baro_corrected %>% filter(Station == "WL_05")
WL_05 <- WL_05[,c("DateTime","BaroTemp_c","WLTemp_c","Station","WL_m")]
...
All_Well <- All_Well[,c("DateTime","BaroTemp_c","WLTemp_c","Station","WL_m")]
All_Well$Q_m3s <- NA
